...
import cs.zju.eva.matchfw.result.*;
...
/**
 * Combine the results for user study
 */
...
//                    AnalysisUtils.calAllRecords(project, algorithm1, algorithm2, fileRecordsMap);
                    AnalysisUtils.calAllRecordsForUserStudy(project, algorithm1, algorithm2, fileRecordsMap);
...
//                    calFileRevisionStatistics(fileRecordsMap, algorithm2.toUpperCase());
            ...
            calAllAlgorithmFileRevisionStatistics(revisionRecordMap);

            List<StmtMapEvalRecord> allStmtRecords = new ArrayList<>();
            for (FileRevision fr: revisionRecordMap.keySet()){
